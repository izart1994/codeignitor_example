  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex justify-content-center">
        <div class="info">
          <a href="#" class="d-block">Welcome <?php echo $this->session->userdata('user_name');?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url().'dashboard/index'; ?>" class="nav-link <?php if($this->uri->uri_string() == 'dashboard/index') { echo 'active'; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'dashboard/index_2'; ?>" class="nav-link <?php if($this->uri->uri_string() == 'dashboard/index_2') { echo 'active'; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url().'dashboard/index_3'; ?>" class="nav-link <?php if($this->uri->uri_string() == 'dashboard/index_3') { echo 'active'; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>
